...
1. In RStudio: Run script 1_DataCleaningEvaluativePrimingTask
   ...
   --> This will get rid of data from pps>2.5sds over mean error  (pp30 and pp64)  
...
2. In RStudio: Run script 2_PreparationAggregatedFile
   ...
   --> Variables will be created: contingency_correct (1 = correct /2 = incorrect /3 = don't know / 4 = both equal)
