...
void aatrial(int i)
{
	...
	ts_clrscr();
 	if (aadata[i].face==0){				
		// if face for this trial is bmp001
		if (((aadata[i].typeface==1)&&(aadata[i].hand==1))||((aadata[i].typeface==2)&&(aadata[i].hand==2))){
			// if (a) appr face and handedness blue=appr OR (b) av face and handedness green=appr
			...
			// if (a) appr face and handedness green=appr OR (b) av face and handedness blue=appr
			if (aadata[i].sizeface==0){
				// if size = 1
				ts_blit(bmp[1], 0, 0);							// bmp 001 presented at size 1
				ts_fgcolor(GREEN);
	 ...
	 if (aadata[i].face==1){
		// if face for this trial is bmp002
		if (((aadata[i].typeface==1)&&(aadata[i].hand==1))||((aadata[i].typeface==2)&&(aadata[i].hand==2))){
			// if (a) appr face and handedness blue=appr OR (b) av face and handedness green=appr
  			if (aadata[i].sizeface==0){
				// if size = 1
 	...
 	if (aadata[i].face==2){
		// if face for this trial is bmp003
		if (((aadata[i].typeface==1)&&(aadata[i].hand==1))||((aadata[i].typeface==2)&&(aadata[i].hand==2))){
			// if (a) appr face and handedness blue=appr OR (b) av face and handedness green=appr
			if (aadata[i].sizeface==0){
				// if size = 1
  	...
  	if (aadata[i].face==3){
		// if face for this trial is bmp004
		if (((aadata[i].typeface==1)&&(aadata[i].hand==1))||((aadata[i].typeface==2)&&(aadata[i].hand==2))){
			// if (a) appr face and handedness blue=appr OR (b) av face and handedness green=appr
			if (aadata[i].sizeface==0){
				// if size = 1
 	...
 	if (aadata[i].face==4){
		// if face for this trial is bmp005
		if (((aadata[i].typeface==1)&&(aadata[i].hand==1))||((aadata[i].typeface==2)&&(aadata[i].hand==2))){
			// if (a) appr face and handedness blue=appr OR (b) av face and handedness green=appr
			if (aadata[i].sizeface==0){
				// if size = 1
	 ...
	 if (aadata[i].face==5){
		// if face for this trial is bmp006
		if (((aadata[i].typeface==1)&&(aadata[i].hand==1))||((aadata[i].typeface==2)&&(aadata[i].hand==2))){
			// if (a) appr face and handedness blue=appr OR (b) av face and handedness green=appr
			if (aadata[i].sizeface==0){
				// if size = 1
 	...
 	if (aadata[i].face==6){
		// if face for this trial is bmp007
		if (((aadata[i].typeface==1)&&(aadata[i].hand==1))||((aadata[i].typeface==2)&&(aadata[i].hand==2))){
			// if (a) appr face and handedness blue=appr OR (b) av face and handedness green=appr
			if (aadata[i].sizeface==0){
				// if size = 1
	 ...
	 if (aadata[i].face==7){
		// if face for this trial is bmp008
		if (((aadata[i].typeface==1)&&(aadata[i].hand==1))||((aadata[i].typeface==2)&&(aadata[i].hand==2))){
			// if (a) appr face and handedness blue=appr OR (b) av face and handedness green=appr
			if (aadata[i].sizeface==0){
				// if size = 1
